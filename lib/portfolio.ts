  ...
  extracurricular: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Engage directly with patients who come in for artificial limb attachment, offering support.',
        'Built a website for the center to improve outreach and information accessibility.',
      ],
    },
  ],
};
